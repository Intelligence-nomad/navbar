            ...
            <>
                ...
                <div className="flex bg-white h-96 container mx-auto">
                    <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
                        <div>
                            <h2 className="text-3xl hover:animate-bounce font-semibold text-gray-800 md:text-4xl">Welcome to <span className="text-purple-800">Intelligence Nomad</span></h2>
